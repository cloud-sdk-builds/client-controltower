...
[`@aws-sdk/client-controltower`](https://www.npmjs.com/package/@aws-sdk/client-controltower/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-controltower@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6uFBtrs4BxfltZ7EiBpEIAriAwhhMspXQSXikd2ACPs4nIm6bYFazpUiNLGZBk4f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-controltower": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-controltower@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-controltower@3.327.0/index.min.mjs": "sha384-6uFBtrs4BxfltZ7EiBpEIAriAwhhMspXQSXikd2ACPs4nIm6bYFazpUiNLGZBk4f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-controltower/blob/refs/tags/3.327.0/LICENSE
```
