...
[`@aws-sdk/client-controltower`](https://www.npmjs.com/package/@aws-sdk/client-controltower/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-controltower@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vxy2QBWiAPBdJKRvhxZycoIdlAokckPU4oSN+RP5xYT9i8KzSht7ouLNBlYaJ7Ms
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-controltower": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-controltower@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-controltower@3.774.0/index.min.mjs": "sha384-vxy2QBWiAPBdJKRvhxZycoIdlAokckPU4oSN+RP5xYT9i8KzSht7ouLNBlYaJ7Ms"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-controltower/blob/refs/tags/3.774.0/LICENSE
```
